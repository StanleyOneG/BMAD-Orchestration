---
name: bmad-analyst
description: "analyst - Business analysis, market research, competitive analysis, requirements elicitation, product briefs, and project documentation. Delegate when the user needs research, analysis, brainstorming, or wants to create a product brief."
tools:
  - Read
  - Grep
  - Glob
...
| 4 | BP | `BP` or "brainstorm-project" | `_bmad/core/workflows/brainstorming/workflow.md` | Guided Project Brainstorming session with final report (optional) |
| 5 | RS | `RS` or "research" | `_bmad/bmm/workflows/1-analysis/research/workflow.md` | Guided Research scoped to market, domain, competitive analysis, or technical research (optional) |
| 6 | PB | `PB` or "product-brief" | `_bmad/bmm/workflows/1-analysis/create-product-brief/workflow.md` | Create a Product Brief (recommended input for PRD) |
| 7 | DP | `DP` or "document-project" | `_bmad/bmm/workflows/document-project/workflow.yaml` | Document your existing project (optional, but recommended for existing brownfield project efforts) |
