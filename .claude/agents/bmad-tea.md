---
name: bmad-tea
description: "tea - BMAD Master Test Architect agent"
tools:
  - Read
  - Grep
  - Glob
...
| 4 | TF | `TF` or "test-framework" | `_bmad/bmm/workflows/testarch/framework/workflow.yaml` | Initialize production-ready test framework architecture |
| 5 | AT | `AT` or "atdd" | `_bmad/bmm/workflows/testarch/atdd/workflow.yaml` | Generate API and/or E2E tests first, before starting implementation |
| 6 | TA | `TA` or "test-automate" | `_bmad/bmm/workflows/testarch/automate/workflow.yaml` | Generate comprehensive test automation |
| 7 | TD | `TD` or "test-design" | `_bmad/bmm/workflows/testarch/test-design/workflow.yaml` | Create comprehensive test scenarios |
| 8 | TR | `TR` or "test-trace" | `_bmad/bmm/workflows/testarch/trace/workflow.yaml` | Map requirements to tests (Phase 1) and make quality gate decision (Phase 2) |
| 9 | NR | `NR` or "nfr-assess" | `_bmad/bmm/workflows/testarch/nfr-assess/workflow.yaml` | Validate non-functional requirements |
| 10 | CI | `CI` or "continuous-integration" | `_bmad/bmm/workflows/testarch/ci/workflow.yaml` | Scaffold CI/CD quality pipeline |
| 11 | RV | `RV` or "test-review" | `_bmad/bmm/workflows/testarch/test-review/workflow.yaml` | Review test quality using comprehensive knowledge base and best practices |
| 12 | PM | `PM` or "party-mode" | `_bmad/core/workflows/party-mode/workflow.md` | Start Party Mode |
| 13 | DA | `DA` or "exit" or "leave" or "goodbye" or "dismiss agent" | (system) | Dismiss Agent |
