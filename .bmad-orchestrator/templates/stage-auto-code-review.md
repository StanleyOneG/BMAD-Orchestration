...
- Review report saved to `_bmad-output/implementation-artifacts/auto-code-review-report.md`
- Report must contain a clear verdict: PASS, CONCERNS, or FAIL
- If issues found, specific findings with severity levels must be documented
...
Read the review report and verify:

- It contains review findings (not a stub or placeholder)
...
- It contains file-by-file or section-by-section findings with severity levels
